...
public class StudentManagementSystem {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("4. Push on To Stack");
            ...
            switch (choice) {
                case 1:
                    ...
                    System.out.println(undergradStudent.name + ", the undergraduate student, is added.");
                    break;
                ...
                case 4:
                    System.out.println("The result of the stack being pushed is...");
                    scanner.close();
                    System.exit(0);
